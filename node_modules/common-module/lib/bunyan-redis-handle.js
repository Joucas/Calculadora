/*
 Taven Kim
 2016-12-20
 data log and request log into redis. 
*/
var bunyan = require("bunyan");
    RedisTransport = require("bunyan-redis"),
...
module.exports.bunyanRedisClient = function (opts) {
    var opts = opts || {};
    opts.name = opts.name || 'TavenKim';
    opts.level = opts.level || 'trace';

    var transport = new RedisTransport({
        container: opts.logstash_key, //与logstash对接key
        client: opts.client
    });
    //创建log实例
...
module.exports.errorLogger = function (opts) {
    ...
    return function (err, req, res, next) {
        ...
        var requestId,
            circle_id = req.circleid || 0,
            m_id = req.masterid || 0,
            acct_id = req.acctid || 0,
            crm_id = req.crmid || 0;
        ...
        var childLogger = requestId !== undefined ? logger.child(logdata) : logger;
        req.log = childLogger;
        ...
        function logging(incoming) {
            ...
            if (json && json.body) {
                //json['shortbody'] = util.inspect(json.body).substring(0, 20);
            }
